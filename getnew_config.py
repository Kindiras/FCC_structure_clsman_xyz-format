...
if __name__ == '__main__':
    strainx=int(input("what is x-strain? could be 1.04 for tensile 4 per or 0.96 for compressive 4 per or 1 for no strain "))
    strainy=int(input("what is y-strrain?"))
    lattice=float(input("what is the lattice constant?"))
    lsize=int(input("what is configuration size like 10 for 10xa where a is lattice constant?"))
